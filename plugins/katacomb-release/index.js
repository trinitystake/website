...
const FALLBACK = {
  version: '1.10.0',
  stale: true,
  releaseUrl: `${RELEASES}/tag/v1.10.0`,
  deb: {
    name: 'katacomb-vpn_1.10.0_amd64.deb',
    url: `${RELEASES}/download/v1.10.0/katacomb-vpn_1.10.0_amd64.deb`,
    size: '113 MB',
  },
  appimage: {
    name: 'katacomb-vpn-1.10.0.AppImage',
    url: `${RELEASES}/download/v1.10.0/katacomb-vpn-1.10.0.AppImage`,
    size: '143 MB',
  },
  checksums: `${RELEASES}/download/v1.10.0/SHA256SUMS`,
  signature: `${RELEASES}/download/v1.10.0/SHA256SUMS.asc`,
};
