...
:::danger Important
 ...
 To accomplish this, import the seed you generated or recovered in [**this step**](/docs/node/manual/node-config#add-a-mnemonic) into a wallet such as [**Leap**](https://docs.sentinel.co/getting-started/wallets/leap/import-seed) or [**Keplr**](https://docs.sentinel.co/getting-started/wallets/keplr/import-seed).
